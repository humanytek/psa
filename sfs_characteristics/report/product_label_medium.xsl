...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="initial_left_pos">1.27</xsl:variable>
	<xsl:variable name="height_increment">2</xsl:variable>
	<xsl:variable name="width_increment">8</xsl:variable>
	<xsl:variable name="frame_height">3cm</xsl:variable>
	<xsl:variable name="frame_width">9.5cm</xsl:variable>
	...
	<xsl:template match="lots">
		<document>
			...
			<stylesheet>
				...
				<paraStyle name="barstandard" fontName="Courier" fontSize="1" spaceBefore="0" spaceAfter="0"/>
				<blockTableStyle id="mytable">
					...
					<blockFont name="Helvetica" size="2" start="0,1" stop="-1,1"/>
	...
	<xsl:template match="lot-line" mode="story">
            <blockTable style="mytable" colWidths="5cm,3cm">
                <tr>
                    <td>
