...
<body>
    %for o in objects :
        ...
        <table class="basic_table" style="color:#121212">
            ...
            %for line in o.invoice_line:
                ...
                %endif
                    ...
                    <td class="basic_td">${line.name or ''|entity}<br/>${get_serial_number(line)}<br/></td>
        ...
        <br clear="all" />
        <table>
        <tr width="33%"><b><%uos_qty=get_uos_qty(o.id)%>${_("Cantidad de producto: ")}${uos_qty}</b></tr>
        </table>
        <table class="basic_table">
            <tr>
                <td class="tax_td">
        ...
        %if o.invoice_sequence_id.approval_id.type == 'cbb':
            ...
            %else:
                <p><b><%bank_ref=get_partner_bank_ref(o.partner_id)%>
                   ${_('Su numero de referencia bancarias es: ')}${bank_ref}</b>
            %endif
        %endif
        <!--code for cfd22-->
