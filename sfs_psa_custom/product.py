...
class product_product(osv.osv):
    ...
    def get_product_available_per_brand(self, cr, uid, ids, context=None):
        ...
        date_str = False
        date_values = False
        where = [tuple(location_ids),tuple(location_ids),tuple(ids),tuple(states), tuple(brand)]
        ...
        if 'in' in what:
            ...
            cr.execute(
                ...
                'and product_id IN %s '\
                'and state IN %s '\
                'and brand_id IN %s' + (date_str and 'and '+date_str+' ' or '') +' '\
                + prodlot_clause + 
